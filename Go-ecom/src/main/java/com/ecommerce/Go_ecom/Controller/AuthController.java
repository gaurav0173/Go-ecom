...
import com.ecommerce.Go_ecom.security.request.LoginRequest;
import com.ecommerce.Go_ecom.security.request.SignupRequest;
import com.ecommerce.Go_ecom.security.response.MessageResponse;
import com.ecommerce.Go_ecom.security.response.UserInfoResponse;
import com.ecommerce.Go_ecom.security.services.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> signOutUser(){
        ...
        return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, cookie.toString())
                             .body(new MessageResponse("You've been Sign out successfully!"));
    }
}
